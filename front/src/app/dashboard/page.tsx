    ...
    return (
        <div className="mx-auto text-justify w-fit text-tertiaryColor text-lg">
            ...
            <div className="mt-4 bg-secondaryColor bg-opacity-90 rounded-xl p-4">
                <h5 className="text-2xl font-bold mb-2">ORDERS</h5>

                <div className="mb-4">
                    <label htmlFor="order-search" className="block mb-1 font-medium">Search order by ID:</label>
                    <input
                        id="order-search"
                        type="text"
                        value={searchOrderId}
                        ...
                        className="px-3 py-2 rounded-md border border-gray-300 w-full text-black"
                    />
                </div>
