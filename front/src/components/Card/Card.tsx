...
export default function Card({ product }: { product: IProduct }) {
  ...
  return (
    <div className="text-quaternaryColor bg-secondaryColor bg-opacity-70 text-center rounded-lg flex flex-col items-center transform group hover:scale-110 hover:transition-all duration-1000 hover:bg-primaryColor h-72 w-auto md:w-60  md:h-80 lg:w-80 lg:h-96 relative lg:static">
